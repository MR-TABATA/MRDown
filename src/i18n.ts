...
const DICT = {
  ja: {
    ...
    scTrash: 'ゴミ箱に移動',
    scViewGroup: '表示',
    scSidebar: '文書一覧の表示／非表示',
    scOutline: 'アウトラインの表示／非表示',
    scEditToggle: '編集とプレビューの切り替え',
    scReading: '読書モード',
    scSettings: '設定',
    scShortcuts: 'このショートカット一覧',
    scSearchGroup: '検索',
    scFind: 'この文書内を検索',
    scFindCross: '開いている文書を横断検索',
    scDiffGroup: '差分と履歴',
    scCompare: '2つのファイルを比較',
    scPrevChange: '前の変更へ',
    scNextChange: '次の変更へ',
    scEditGroup: '編集中',
    scBold: '太字',
    ...
    scUndo: '取り消す',
    scRedo: 'やり直す',
    scIndent: 'リストの階層を下げる／上げる',
    scExportGroup: '書き出し',
    scExportHtml: 'HTML として書き出す',
    scExportPdf: 'PDF として書き出す',
    scListGroup: '文書一覧',
    scListNote: '文書一覧を選んでいるとき',
    scStep: '前後の文書へ切り替え',
    scMove: '選んだ文書を並べ替え',
    scEscGroup: 'そのほか',
    scEscape: 'パネルを閉じる／読書モードを抜ける',
    ...
    fmtTaskListToWbs: '箇条書きを WBS に（ID を振り直す）',
    fmtAddColumn: '列を右に足す',
    fmtDeleteColumn: 'この列を消す',
    fmtCycleAlign: '列の寄せを変える',
    fmtAlignColumns: '表のパイプ位置を揃える',
    fmtTableMore: '表の操作',
    fmtTableMenuEmpty: '表の中にカーソルを置いてください',
    fmtWbs: 'WBS を挿入',
    fmtCase: '大文字小文字を回す',
    fmtSortText: '行を辞書順に',
    fmtSortNumber: '行を数値順に',
    fmtSortLength: '行を長さ順に',
    fmtJoin: '行を 1 行にまとめる',
    fmtSplit: '1 行を複数行に分ける',
    fmtWrap: '80 桁で折り返す',
    fmtDedent: '字下げを戻す',
    fmtDecode: 'エンティティ / URL を戻す',
    // `/` insert menu
  ...
  en: {
    ...
    scViewGroup: 'View',
    scSidebar: 'Show or hide the document list',
    scOutline: 'Show or hide the outline',
    scEditToggle: 'Switch between editing and preview',
    scReading: 'Reading mode',
    scSettings: 'Settings',
    scShortcuts: 'This list of shortcuts',
    scSearchGroup: 'Search',
    scFind: 'Find in this document',
    scFindCross: 'Search across open documents',
    scDiffGroup: 'Diff and history',
    scCompare: 'Compare two files',
    scPrevChange: 'Previous change',
    scNextChange: 'Next change',
    scEditGroup: 'While editing',
    scBold: 'Bold',
    scItalic: 'Italic',
    scUndo: 'Undo',
    scRedo: 'Redo',
    scIndent: 'Indent or outdent a list item',
    scExportGroup: 'Export',
    scExportHtml: 'Export as HTML',
    scExportPdf: 'Export as PDF',
    scListGroup: 'Document list',
    scListNote: 'when the document list has focus',
    scStep: 'Step to the previous or next document',
    scMove: 'Reorder the selected documents',
    scEscGroup: 'Anywhere',
    scEscape: 'Close a panel, or leave reading mode',
    ...
    fmtTaskListToWbs: 'Bullets to WBS (renumber IDs)',
    fmtAddColumn: 'Add column to the right',
    fmtDeleteColumn: 'Delete this column',
    fmtCycleAlign: 'Cycle column alignment',
    fmtAlignColumns: 'Align table pipes',
    fmtTableMore: 'Table actions',
    fmtTableMenuEmpty: 'Place the caret inside a table',
    fmtWbs: 'Insert a WBS',
    fmtCase: 'Cycle letter case',
    fmtSortText: 'Sort lines A→Z',
    fmtSortNumber: 'Sort lines by number',
    fmtSortLength: 'Sort lines by length',
    fmtJoin: 'Join lines into one',
    fmtSplit: 'Split one line into many',
    fmtWrap: 'Wrap at 80 columns',
    fmtDedent: 'Remove shared indent',
    fmtDecode: 'Decode entities / URL',
    // `/` insert menu
